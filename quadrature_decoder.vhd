...
ENTITY quadrature_decoder IS
  GENERIC(
    positions                : INTEGER := 640;       --size of the position counter (i.e. number of positions counted)
  ...
  PORT(
    ...
    position     : BUFFER INTEGER RANGE 0 TO positions-1 := 320); --current position relative to index or initial value
